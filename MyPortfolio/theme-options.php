	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Строка 1', 'sampletheme' ); ?></th>
					<td>
						<input id="sample_theme_options[sometext1]" class="regular-text" type="text" name="sample_theme_options[sometext1]" value="<?php esc_attr_e( $options['sometext1'] ); ?>" />
						<label class="description" for="sample_theme_options[sometext1]"><?php _e( 'Вывод в hero первой строки', 'sampletheme' ); ?></label>
					</td>
				</tr>
				<tr valign="top"><th scope="row"><?php _e( 'Строка 2', 'sampletheme' ); ?></th>
					<td>
						...
						<label class="description" for="sample_theme_options[sometext2]"><?php _e( 'Вывод в hero второй строки', 'sampletheme' ); ?></label>
					</td>
				</tr>
